<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CompanyUI.aspx.cs" Inherits="CompanyWebApp.UI.CompanyUI" %>
...
<%--    <asp:Button  ID="logoutButton" runat="server" Text="Logout" BackColor="red" OnClick="logoutButton_OnClick" />--%>
    ...
    <div>
        <h1 style="text-align: center; color: #27BDB2; display: block;font-size: 2em;margin-top: 1.67em;font-weight: bold ">Company Setup</h1>
        <table>
           <tr>
              <td>
                   <asp:Label ID="Label1" runat="server" Text="Name"></asp:Label>
                   <asp:TextBox ID="nameTextBox" for="nameTextBox" runat="server" Width="209px"></asp:TextBox>
                   <asp:RegularExpressionValidator Display="Dynamic" ControlToValidate="nameTextBox" ID="MyPassordMinMaxLengthValidator" ValidationExpression="^[\s\S]{2,15}$" runat="server" ErrorMessage="Company Name must be between 2 and 15 characters long." ForeColor="red"></asp:RegularExpressionValidator>
               </td>
               <td></td>
               <%--<td>
                   <asp:TextBox ID="nameTextBox" for="nameTextBox" runat="server" Width="209px"></asp:TextBox>
                   <asp:RegularExpressionValidator Display="Dynamic" ControlToValidate="nameTextBox" ID="MyPassordMinMaxLengthValidator" ValidationExpression="^[\s\S]{4,15}$" runat="server" ErrorMessage="Company Name must be between 4 and 15 characters long." ForeColor="red"></asp:RegularExpressionValidator>
               </td>--%>
           </tr>
            <tr>
                <td>
        ...
        <div>
        <asp:GridView ID="companyGridView" runat="server" AutoGenerateColumns="False" BackColor="LightGoldenrodYellow" BorderColor="Tan" BorderWidth="1px" CellPadding="2" ForeColor="Black" GridLines="None">
        ...
        <asp:HyperLink ID="refreshHyperLink" runat="server" NavigateUrl="CompanyUI.aspx">Refresh</asp:HyperLink>
        </div>
    ...
    <script>
        ...
        $("#form1").validate({
            ...
            messages: {
                nameTextBox: "Please enter your Company Name"
            }
        }); 
